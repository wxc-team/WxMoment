...
function _sendEvent (type, name) {
    if (typeof pgvSendClick === "function" && !!type && !!name && !!window.WxMoment.projectName) {
        pgvSendClick({hottag: 'WXM.' + window.WxMoment.projectName + "." + type + "." + name});
    }
}
